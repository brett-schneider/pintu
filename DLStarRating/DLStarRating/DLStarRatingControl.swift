//
//  DLStarRatingControl.swift
//  pintu3
//
//  Created by Brett on 30/10/16.
//  Copyright © 2016 Brett. All rights reserved.
//

import UIKit

protocol DLStarRatingDelegate: class {
    func newRating(control: DLStarRatingControl!, _ rating: Float)
}

class DLStarRatingControl: UIControl {
    
    public var numberOfStars: Int
    public var currentIdx: Int
    public var star: UIImage
    public var highlightedStar: UIImage
    public var isFractionalRatingEnabled: Bool
    
    func initWithFrame(frame: CGRect) -> AnyObject {
        
    }
    
    func initWithFrame(frame: CGRect, andStars _numberOfStars: NSUInteger, isFractional isFract:Bool) -> AnyObject {
        
    }
    
    func setStar(defaultStarImage: UIImage, highlightedStar highlightedStarImage: UIImage, atIndex index:int) {
