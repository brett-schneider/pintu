...
static NSString* camLocationSelectorSegue = @"camLocationSelectorSegue";
...
@interface AcquireCam () <AVCaptureFileOutputRecordingDelegate>
...
- (void)viewDidLoad
{
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        AVCaptureDevice *videoDevice = [AcquireCam deviceWithMediaType:AVMediaTypeVideo preferringPosition:AVCaptureDevicePositionBack];
...
- (IBAction)toggleMovieRecording:(id)sender
{
    ...
    dispatch_async( self.sessionQueue, ^{
        if ( ! self.movieFileOutput.isRecording ) {
            ...
            [AcquireCam setFlashMode:AVCaptureFlashModeOff forDevice:self.videoDeviceInput.device];
...
- (IBAction)changeCamera:(id)sender
{
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        AVCaptureDevice *videoDevice = [AcquireCam deviceWithMediaType:AVMediaTypeVideo preferringPosition:preferredPosition];
        ...
        if ( [self.session canAddInput:videoDeviceInput] ) {
            ...
            [AcquireCam setFlashMode:AVCaptureFlashModeAuto forDevice:videoDevice];
...
- (IBAction)snapStillImage:(id)sender
{
    dispatch_async( self.sessionQueue, ^{
        ...
        [AcquireCam setFlashMode:AVCaptureFlashModeAuto forDevice:self.videoDeviceInput.device];
        ...
        [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:connection completionHandler:^( CMSampleBufferRef imageDataSampleBuffer, NSError *error ) {
            if ( imageDataSampleBuffer ) {
                ...
                [self performSegueWithIdentifier:camLocationSelectorSegue sender:nil];
            }
            else {
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    // NSLog(@"sender segue: %@", sender);
    if ([[segue identifier] isEqualToString:camLocationSelectorSegue]) {
